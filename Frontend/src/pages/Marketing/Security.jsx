    ...
    <div className="container px-6 py-12 max-w-4xl mx-auto text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        <div className="p-6 bg-card border border-border rounded-xl space-y-3">
          <div className="w-10 h-10 rounded-lg bg-primary/10 text-primary flex items-center justify-center"><Key className="w-5 h-5" /></div>
        ...
        <div className="p-6 bg-card border border-border rounded-xl space-y-3">
          <div className="w-10 h-10 rounded-lg bg-indigo-500/10 text-indigo-500 flex items-center justify-center"><Lock className="w-5 h-5" /></div>
        ...
        <div className="p-6 bg-card border border-border rounded-xl space-y-3">
          <div className="w-10 h-10 rounded-lg bg-emerald-500/10 text-emerald-500 flex items-center justify-center"><Shield className="w-5 h-5" /></div>
        ...
        <div className="p-6 bg-card border border-border rounded-xl space-y-3">
          <div className="w-10 h-10 rounded-lg bg-cyan-400/10 text-cyan-400 flex items-center justify-center"><EyeOff className="w-5 h-5" /></div>

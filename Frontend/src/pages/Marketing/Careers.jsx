    ...
    <div className="container px-6 py-12 max-w-4xl mx-auto text-left">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
        <div className="p-6 bg-card border border-border rounded-xl">
          <div className="w-10 h-10 rounded-lg bg-primary/10 text-primary flex items-center justify-center mb-4"><Target className="w-5 h-5" /></div>
        ...
        <div className="p-6 bg-card border border-border rounded-xl">
          <div className="w-10 h-10 rounded-lg bg-indigo-500/10 text-indigo-500 flex items-center justify-center mb-4"><Heart className="w-5 h-5" /></div>
        ...
        <div className="p-6 bg-card border border-border rounded-xl">
          <div className="w-10 h-10 rounded-lg bg-emerald-500/10 text-emerald-500 flex items-center justify-center mb-4"><Compass className="w-5 h-5" /></div>
      ...
      {/* 🚀 FUTURE OPENINGS */}
      <section className="p-8 bg-card border border-border rounded-2xl shadow-sm text-center">
        ...
        <span className="inline-block px-4 py-1.5 bg-secondary text-primary font-bold rounded-lg border border-border/80 text-[10px] uppercase tracking-wider select-none">

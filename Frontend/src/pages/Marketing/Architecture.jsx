...
export default function Architecture() {
  ...
  return (
    <div className="container px-6 py-12 max-w-4xl mx-auto text-left">
      ...
      <section className="p-8 bg-card border border-border rounded-2xl shadow-sm mb-16 text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-around gap-6 max-w-2xl mx-auto">
          {/* Frontend */}
          <div className="p-4 bg-secondary/60 border border-border rounded-xl w-36 text-center flex flex-col items-center gap-2">
          ...
          <div className="text-indigo-500 font-black text-xs select-none md:rotate-0 rotate-90">→</div>
      ...
      <section className="space-y-8">
        ...
        <div className="p-6 bg-card border border-border rounded-xl">
          <h3 className="font-bold text-sm text-indigo-500 mb-2">💼 Placement Referrals workflow</h3>
          <p className="text-xs text-muted-foreground leading-relaxed">

...
import { useVerifierSignup } from '../../../services/Referrals/Auth/hooks.js';
...
/**
 * Verifier Signup Page Component
 * Allows college authorities to register for a verification account.
 */
export function VerifierSignupPage() {
  const {
    data,
    errors,
    isSubmitting,
      ...
      >
        ...
        <Card className="border-2">
          <CardHeader className="space-y-1">
            ...
            <CardDescription>Register as a college authority</CardDescription>
          </CardHeader>
          ...
          <CardFooter className="flex justify-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link to="/auth/verifier/login" className="text-verifier font-medium hover:underline">
                Login
              </Link>
            </p>
          </CardFooter>

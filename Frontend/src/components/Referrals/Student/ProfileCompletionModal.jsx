...
const ALL_STEPS = [
  {
    ...
    description: "Add your branch and graduation year",
    icon: GraduationCap,
    field: "academic",
  },
  {
  ...
  },
  {
    key: "github",
    title: "GitHub",
    description: "Add your GitHub profile",
    icon: Code,
    field: "github",
  },
];
...
export function ProfileCompletionModal({
  ...
  const saveCurrentStep = async () => {
    ...
    switch (currentStep.key) {
      ...
      case "Link":
        if (!LinkUrl) {
          throw new Error("Please add your Link URL");
        }
        await linkedInApi.updateLinkUrl(LinkUrl);
        break;

      case "Code":
        if (!CodeUrl) {
          throw new Error("Please add your Code URL");
        }
        try {
          await githubApi.addCodeUrl(CodeUrl);
        } catch {
          await githubApi.updateCodeUrl(CodeUrl);
        }
        break;
      default:
        break;
  ...
  const renderStepContent = () => {
    ...
    switch (currentStep.key) {
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setAcademicData({ ...academicData, branch: e.target.value })
                }
              />
            </div>
            <div>
        ...
        return (
          <div className="space-y-4 text-center">
            <div className="border-2 border-dashed rounded-lg p-8">
              ...
              {resumeFile && (
                <p className="mt-2 text-sm text-success">{resumeFile.name}</p>
              )}
            </div>
          </div>
        );
      ...
      case "Code":
        return (
          <div>
            <Label>Code Profile URL</Label>
            <Input
              placeholder="https://Code.com/username"
              value={CodeUrl}
      ...
      default:
        return (
          <p className="text-sm text-muted-foreground">
            Please complete this section in your profile settings.
          </p>
        );
    }
  };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          >
            ...
            <p className="text-muted-foreground mb-6">
              You can now apply for referral opportunities.
            </p>
